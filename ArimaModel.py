...
Each object is an Arima model with input variables are data and period.

Method
------
    From the original data set, we will calculate profit based on log formula of "close" column.
    ...
    Predicting the future value of each stock then return the actual value.
